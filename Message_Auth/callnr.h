...
#define PM_RETRIEVE			(PM_BASE + 49)
#define PM_CLEAR			(PM_BASE + 50)
#define PM_SETUP			(PM_BASE + 51)
#define PM_CREATE_GROUP		(PM_BASE + 52)
#define PM_REMOVE_GROUP		(PM_BASE + 53)
#define PM_ADD_GROUP_LEADER	(PM_BASE + 54)
#define PM_REMOVE_GROUP_LEADER	(PM_BASE + 55)
#define PM_DENY_SEND		(PM_BASE + 56)
#define PM_DENY_RECEIVE		(PM_BASE + 57)
#define PM_CREATE_SECURE_GROUP	(PM_BASE + 58)
#define PM_CREATE_PUBLIC_GROUP	(PM_BASE + 59)
#define PM_ADD_USER_TO_GROUP	(PM_BASE + 60)
#define PM_REMOVE_USER_FROM_GROUP	(PM_BASE + 61)
#define NR_PM_CALLS		62	/* highest number from base plus one */
